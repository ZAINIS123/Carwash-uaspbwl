...
<form action="/dashboard/pelanggan/{{ $dataPelanggan->no }}" method="post" class="mt-4">
    ...
    <div class="col-lg-8">
        <div class="row">
            <div class="col">
                <div class="mb-3">
                    <label for="id_gol" class="form-label">Kendaraan</label>
        ...
        <div class="row mt-5">
            <div class="mb-3 col-md-4">
                ...
                <input type="number" min="1" name="no" id="no" class="form-control @error('no') is-invalid @enderror"
                    aria-describedby="validationNo" value="{{ old('no', $dataPelanggan->no) }}" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nama" id="nama" class="form-control @error('nama') is-invalid @enderror"
                aria-describedby="validationNama" value="{{ old('nama', $dataPelanggan->nama) }}" required>
        ...
        <div class="row mt-5">
            <div class="col">
                <div class="mb-3">
                    ...
                    <input type="text" name="hp" id="hp" class="form-control @error('hp') is-invalid @enderror"
                        aria-describedby="validationHp" value="{{ old('hp', $dataPelanggan->hp) }}" required>
            ...
            <div class="col">
                <div class="mb-3">
                    <label for="ktp" class="form-label">Jenis Kendaraan</label>
                    <input type="text" name="ktp" id="ktp" class="form-control @error('ktp') is-invalid @enderror"
                        aria-describedby="validationKtp" value="{{ old('ktp', $dataPelanggan->ktp) }}" required>
        ...
        <div class="row">
            <div class="col">
                <div class="mb-3">
                    ...
                    <input type="number" min="0" name="seri" id="seri"
                        class="form-control @error('seri') is-invalid @enderror" aria-describedby="validationSeri"
                        value="{{ old('seri', $dataPelanggan->seri) }}" required>
            ...
            <div class="col">
                <div class="mb-3">
                    <label for="meteran" class="form-label">Harga</label>
                    <input type="number" min="0" name="meteran" id="meteran"
                        class="form-control @error('meteran') is-invalid @enderror" aria-describedby="validationMeteran"
                        value="{{ old('meteran', $dataPelanggan->meteran) }}" required>
            ...
            <div class="col">
                <div class="mb-3">
                    ...
                    <select name="aktif" id="aktif" class="form-select" required>
                        <option value="Y" @if (old('aktif', $dataPelanggan->aktif) == 'Y') {{ 'selected' }} @endif>Sudah
                            Dicuci
                        </option>
                        <option value="N" @if (old('aktif', $dataPelanggan->aktif) == 'N') {{ 'selected' }} @endif>Belum
                            siap dicuci
                            Aktif</option>
                    </select>
                </div>
