    ...
    <div class="col-lg-8">
        ...
        <div class="row mt-5">
            <div class="mb-3 col-md-4">
                ...
                <input type="number" min="1" name="no" id="no" class="form-control @error('no') is-invalid @enderror"
                    aria-describedby="validationNo" value="{{ old('no') }}" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nama" id="nama" class="form-control @error('nama') is-invalid @enderror"
                aria-describedby="validationNama" value="{{ old('nama') }}" required>
            ...
            <div class="col">
                <div class="mb-3">
                    ...
                    <input type="text" name="hp" id="hp" class="form-control @error('hp') is-invalid @enderror"
                        aria-describedby="validationHp" value="{{ old('hp') }}" required>
            ...
            <div class="col">
                <div class="mb-3">
                    ...
                    <input type="text" name="ktp" id="ktp" class="form-control @error('ktp') is-invalid @enderror"
                        aria-describedby="validationKtp" value="{{ old('ktp') }}" required>
            ...
            <div class="col">
                <div class="mb-3">
                    ...
                    <select name="aktif" id="aktif" class="form-select" required>
                        <option value="Y" @if (old('aktif')=='Y' ) {{ 'selected' }} @endif>sudah tercuci</option>
                        <option value="N" @if (old('aktif')=='N' ) {{ 'selected' }} @endif>Belum tercuci</option>
                    </select>
                </div>
            </div>
        </div>
